...
class AndroidIntent {
  ...
  Map<String, dynamic> _buildArguments() {
    return {
      ...
      if (uriParts != null)
        'uriParts': {
          if (uriParts?.scheme != null) 'scheme': uriParts!.scheme,
          if (uriParts?.ssp != null) 'ssp': uriParts!.ssp,
          if (uriParts?.fragment != null) 'fragment': uriParts!.fragment,
        },
    };
  }
}
...
class UriParts {
  ...
  UriParts({required this.scheme, this.ssp, this.fragment});
}
